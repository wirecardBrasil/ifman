...
(function() {
  $(function() {
    return $(".delete-feature").on("ajax:success", function(e, data, status, xhr) {
      return $("#" + data.feature).remove();
    });
  });
...
(function() {
  $(function() {
    $("#add-user-form").on("ajax:success", function(e, data, status, xhr) {
    ...
    $("#percentage").on("slide", function(event) {
      return $("#current-percentage").text(event.value);
    });
    return $(".delete-user").on("ajax:success", function(e, data, status, xhr) {
